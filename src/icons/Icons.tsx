...
export const PerfumeIcon = (props: React.SVGAttributes<SVGSVGElement>) => (
  <svg
...
export const BeakerIcon = (props: React.SVGAttributes<SVGSVGElement>) => (
  <svg
    ...
    strokeWidth={2}
    className="lucide lucide-flask-conical w-5 h-5 text-gray-500"
    data-fg-cnm55=":0:/src/components/MixCard.tsx:50:15:1880:50:e:FlaskConical:::::rTH"
    {...props}
  >
